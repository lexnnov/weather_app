...
Now you can rename `src/Home.css` to `src/Home.scss` and update `src/Home.jss` to import `src/Home.scss`.
...
Now you are ready to use the imported reactstrap components within your component hierarchy defined in the render method. Here is an example [`Homee.js`](https://gist.githubusercontent.com/zx6658/d9f128cd57ca69e583ea2b5fea074238/raw/a56701c142d0c622eb6c20a457fbc01d708cb485/Home.js) redone using reactstrap.
